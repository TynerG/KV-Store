...
These experiements can be reproduced by executing the binary file `experimentBTree` in the build directory. 
...
filename = "lsm_insert_throughput"
data_path = os.path.join("./data", f"{filename}.csv")
